...
@Component({
  selector: 'app-java-list',
  templateUrl: './java-list.component.html',
  styleUrls: ['./java-list.component.css']
})
export class JavaListComponent implements OnInit {
  data = [
    {
      id:1,
      name:'Spring MVC',
  ...
  getDetail(id) {
     this.router.navigate(['/java', {outlets: {'Detail': [id]}}]);
  }
}
